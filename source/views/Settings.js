	...
	components:[
		...
		components:[
			...
			components:[
				...
				{kind: "ListItem", icon: "assets/icons/com.palm.app.wifi/icon-256x256.png", title: "Wi-Fi", ontap: "openPanel", targetPanel: "WiFiPanel",
				components:[
					{name: "WiFiToggle",
				...
				{kind: "ListItem", icon: "assets/icons/com.palm.app.phone/icon.png", title: "Telephony", ontap: "openPanel", targetPanel: "TelephonyPanel"},
				...
				{kind: "ListItem", icon: "assets/icons/com.palm.app.certificate/icon.png", title: "Certificates", ontap: "openPanel", targetPanel: "CertificatesPanel"},

				//Core Settings
				{kind: "onyx.Toolbar", classes: "list-header", content: "Core"},
				{kind: "ListItem", icon: "assets/icons/com.palm.app.screenlock/icon-256x256.png", title: "Screen & Lock", ontap: "openPanel", targetPanel: "ScreenLockPanel"},
				{kind: "ListItem", icon: "assets/icons/com.palm.app.dateandtime/icon-256x256.png", title: "Date & Time", ontap: "openPanel", targetPanel: "DateTimePanel"},
				{kind: "ListItem", icon: "assets/icons/com.palm.app.streamingmusicplayer/icon.png", title: "Sound & Ringtones", ontap: "openPanel", targetPanel: "AudioPanel",
				components:[
				...
				{kind: "ListItem", icon: "assets/icons/com.palm.app.searchpreferences/icon-256x256.png", title: "Search Preferences", ontap: "openPanel", targetPanel: "SearchPreferencesPanel"},
				{kind: "ListItem", icon: "assets/icons/com.palm.app.languagepicker/icon-256x256.png", title: "Language & Input", ontap: "openPanel", targetPanel: "LanguageInputPanel"},
				{kind: "ListItem", name: "DevModemListItem", icon: "assets/icons/com.palm.app.devmodeswitcher/icon.png", title: "Developer Options", ontap: "openPanel", targetPanel: "DevOptionsPanel", showing: false},
				{kind: "ListItem", icon: "assets/icons/com.palm.app.deviceinfo/icon-256x256.png", title: "About", ontap: "openPanel", targetPanel: "AboutPanel"}
			]}
		]},
		{name: "ContentPanels",
		kind: "enyo.Panels",
